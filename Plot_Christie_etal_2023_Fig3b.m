...
% Fig3_AmundsenCS_point_mask.csv (provided with code)
...
roi_points = csvread('Fig3_AmundsenCS_point_mask.csv',1,0); % In Polar Stereographic
...
hline = yline(-422); % mean depth of GL at region of interest from IBCSO (Arndt et al., 2013)
hline.Color='w';
hline.LineWidth=1;
...
GL_depth = 422; % mean depth of GL at region of interest from IBCSO (Arndt et al., 2013)
