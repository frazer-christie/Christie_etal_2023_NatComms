...
% This code reads in CMEMS GREP data, extracts data over the area of interest and plots Fig. 3b of Christie et al. (Nature Communications, 2023)
% Code written by Frazer Christie, Scott Polar Research Institute, University of Cambridge, January 2023

%% Dependancies
%The code is dependent on the following input datasets, functions and toolboxes, which either accompany this code or are availble at 
% the links/references detailed below:

% Fig3_RossCS_point_mask.csv (provided with code)
...
roi_points = csvread('Fig3_RossCS_point_mask.csv',1,0); % In Polar Stereographic
...
hline = yline(-305); % mean depth of GL at region of interest from IBCSO (Arndt et al., 2013)
hline.Color='w';
hline.LineWidth=1;
...
GL_depth = 305; % mean depth of GL at region of interest from IBCSO (Arndt et al., 2013)
